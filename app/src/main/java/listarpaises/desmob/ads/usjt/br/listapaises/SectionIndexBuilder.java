...
public class SectionIndexBuilder {
    ...
    public static Object[] buildSectionHeaders(br.usjt.ads.desmob.listarpaises.Pais[] paises){
    ...
    public static Hashtable<Integer, Integer> buildSectionForPositionMap(br.usjt.ads.desmob.listarpaises.Pais[] paises){
    ...
    public static Hashtable<Integer, Integer> buildPositionForSectionMap(br.usjt.ads.desmob.listarpaises.Pais[] paises){
        Hashtable<Integer, Integer> resultados = new Hashtable<>();
        TreeSet<String> usados = new TreeSet<>();
